...
ngdbuild -uc ..\..\example_design\example_ila.ucf -p xc6slx9-ftg256-3 -sd . example_ila.ngc example_ila.ngd
REM Check Results
...
REM Run map
ECHO 'Running MAP'
map -w -p xc6slx9-ftg256-3 -o example_ila.map.ncd example_ila.ngd
REM Check Results
