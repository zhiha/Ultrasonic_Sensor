...
xst -ifn xst.scr
move PLL_WIFI_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_WIFI_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_WIFI_exdes.ucf PLL_WIFI_exdes

echo 'Running map'
map -timing -pr b PLL_WIFI_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm PLL_WIFI_exdes -w routed.ncd routed.v
cd ..
